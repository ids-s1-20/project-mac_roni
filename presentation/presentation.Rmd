...
```{r all-airlines-ratings-breakdown, message = FALSE, echo = FALSE, warning = FALSE, out.width = "100%"}
airline_nonas %>%
  group_by(airline_name, date) %>%
...
#### Findings within the amenity of time
For an overall rating to increase over time, all contributors have to increase. 
- Passengers receive a good experience in every perspective

For an overall rating to decrease over time, there are two possibilities:
- Contributor gets lower ratings consistently
- Contributor starts to decrease 
